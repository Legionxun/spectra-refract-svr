...
This is version 3.2.1, which mainly fixes the bug of incomplete display of some buttons on the left button panel under different screens.
...
​        该版本主要修复了不同屏幕下左侧按钮面板部分按钮显示不全的Bug。
