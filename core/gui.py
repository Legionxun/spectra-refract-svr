# core/gui.py
import threading, subprocess, logging.handlers, shutil, datetime, os, sys, time, webbrowser, joblib
...
from .utils import get_output_path, get_unique_filename
...
class RefractiveIndexApp(QMainWindow):
    ...
    def __init__(self):
        ...
        # 设置图标
        try:
            icon_path = get_output_path("./img/icon.ico")
        ...
        self.theoretical_data_generated = False
        ...
        self.setMenuBar(self.menu_builder.menu_bar)
        ...
        # 初始化自动更新器
        self.auto_updater = AutoUpdater(self, "1.5.0")
    ...
    def create_main_interface(self):
        ...
        self.left_panel = self.left_panel_builder.create()  # 修正：使用返回值
    ...
    def disable_all_buttons_except_stop(self):
        ...
        if hasattr(self.left_panel_builder, 'gen_data_btn'):
            self.left_panel_builder.gen_data_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'custom_gen_data_btn'):
            self.left_panel_builder.custom_gen_data_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'data_aug_btn'):
            self.left_panel_builder.data_aug_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'import_original_btn'):
            self.left_panel_builder.import_original_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'import_processed_btn'):
            self.left_panel_builder.import_processed_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'train_btn'):
            self.left_panel_builder.train_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'load_btn'):
            self.left_panel_builder.load_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'export_btn'):
            self.left_panel_builder.export_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'predict_btn'):
            self.left_panel_builder.predict_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'batch_pred_btn'):
            self.left_panel_builder.batch_pred_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'history_btn'):
            self.left_panel_builder.history_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'vis_btn'):
            self.left_panel_builder.vis_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'opt_history_btn'):
            self.left_panel_builder.opt_history_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'compare_btn'):
            self.left_panel_builder.compare_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'monitor_btn'):
            self.left_panel_builder.monitor_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'refresh_btn'):
            self.left_panel_builder.refresh_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'clear_output_btn'):
            self.left_panel_builder.clear_output_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'clear_plot_btn'):
            self.left_panel_builder.clear_plot_btn.setEnabled(False)

        # 启用停止训练和停止生成按钮
        if hasattr(self.left_panel_builder, 'stop_train_btn'):
            self.left_panel_builder.stop_train_btn.setEnabled(True)
    ...
    def enable_all_buttons(self):
        ...
        # 启用菜单项
        self.menu_builder.enable_all_buttons()

        # 启用左侧面板按钮（除了停止训练和停止生成按钮）
        if hasattr(self.left_panel_builder, 'gen_data_btn'):
            self.left_panel_builder.gen_data_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'custom_gen_data_btn'):
            self.left_panel_builder.custom_gen_data_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'data_aug_btn'):
            self.left_panel_builder.data_aug_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'import_original_btn'):
            self.left_panel_builder.import_original_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'import_processed_btn'):
            self.left_panel_builder.import_processed_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'train_btn'):
            self.left_panel_builder.train_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'load_btn'):
            self.left_panel_builder.load_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'export_btn'):
            self.left_panel_builder.export_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'predict_btn'):
            self.left_panel_builder.predict_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'batch_pred_btn'):
            self.left_panel_builder.batch_pred_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'history_btn'):
            self.left_panel_builder.history_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'vis_btn'):
            self.left_panel_builder.vis_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'opt_history_btn'):
            self.left_panel_builder.opt_history_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'compare_btn'):
            self.left_panel_builder.compare_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'monitor_btn'):
            self.left_panel_builder.monitor_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'refresh_btn'):
            self.left_panel_builder.refresh_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'clear_output_btn'):
            self.left_panel_builder.clear_output_btn.setEnabled(True)
        if hasattr(self.left_panel_builder, 'clear_plot_btn'):
            self.left_panel_builder.clear_plot_btn.setEnabled(True)

        # 禁用停止训练和停止生成按钮
        if hasattr(self.left_panel_builder, 'stop_train_btn'):
            self.left_panel_builder.stop_train_btn.setEnabled(False)
        if hasattr(self.left_panel_builder, 'stop_generation_btn'):
            self.left_panel_builder.stop_generation_btn.setEnabled(False)

    def generate_theoretical_data(self):
        """生成理论数据（默认范围）"""
        self.logger.info("用户请求生成理论数据（默认范围）")
        print("\n=== 开始生成理论数据（默认范围：1.500-1.700）===")
        self._start_data_generation(np.arange(1.5, 1.701, 0.001))
    ...
    def _confirm_custom_generation(self, dialog):
        ...
        try:
            ...
            rn_range = np.arange(start, end + step / 2, step)  # +step/2 防止浮点数精度问题
            dialog.close()
    ...
    def _start_data_generation(self, rn_range):
        ...
        try:
            ...
            def update_progress(current, total, message):
                ...
                self.output_text.insertPlainText(progress_text)
            ...
            def run_generation():
                try:
                    ...
                    self.prism_simulator = PrismSimulator(output_callback=update_progress)
                    ...
                    if not self.theoretical_data_stop_flag:
    ...
    def save_prediction_result(self, prediction):
        """保存预测结果"""
        try:
            output_dir = get_output_path("prediction_results")
            os.makedirs(output_dir, exist_ok=True)

            # 获取唯一文件名
            base_name = "prediction_result"
            txt_path = get_unique_filename(output_dir, base_name, "txt")
            img_path = get_unique_filename(output_dir, base_name, "png")
    ...
    def show_usage_guide(self):
        ...
        try:
            ...
            if not os.path.exists(pdf_path):
                webbrowser.open("https://github.com/yourusername/optisvr/docs/README.pdf")
                print("在线使用手册已打开")
                return
    ...
    def show_about(self):
        ...
        about_dialog.setWindowTitle("关于 OptiSVR")
        ...
        # 功能描述
        desc_text = QLabel("""
        <p>本系统使用支持向量回归（Support Vector Regression, SVR）算法
        和分簇回归模型预测棱镜的折射率。通过分析入射角-偏向角图像，
        系统能够准确预测分光计的折射率特性。</p>
