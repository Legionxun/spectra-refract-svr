...
CONFIG = {
    ...
    "icon": get_output_path(r".\img\icon.ico"), # 图标路径
    "download": get_output_path(r".\download"), # 下载保存路径
    "user_info": get_output_path(r".\All_Users"), # 用户信息保存路径
    ...
    "repo_username": "Legionxun",
    "key": b'TsXSllmJyGcpRzdkqCYxKL9YbWDfqGGLXQhWBBvLS7U=', # 加密密钥
    "repo_token_bytes": b'gAAAAABoxvrIxHYxca5GZDEy7Ck-IKu49aYCBwiP-HSDFs1c'
                        b'NhI8PpIs_vUsvNQhkbGAzTFgOZFmh1o9L6CH9fM0Xt5AYEh6'
                        b'91nvtmT6k5w4gVmE22d_E7wcRCRAgI0C2PnkS_EHAkmT',
    "cloud_sync_name": "OptiSVR-Cloud-Sync",
    "refractive_index_decimal_places": 4,  # 折射率显示的小数位数
}
