...
class MenuBuilder:
    ...
    def build_menu(self):
        ...
        baidu_sync_action = tools_menu.addAction("云同步", self.app.open_cloud_sync_settings)
        tools_menu.addSeparator()
        settings_action = tools_menu.addAction("系统设置", self.app.open_settings_dialog)
        ...
        self.menu_items = {
            ...
            "云同步": (tools_menu, baidu_sync_action),
            "系统设置": (tools_menu, settings_action),
