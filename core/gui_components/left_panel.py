...
class LeftPanelBuilder:
    ...
    def create(self):
        ...
        data_group_layout.setSpacing(5)
        ...
        data_group_label.setStyleSheet("color: #2c3e50; margin: 6px 0 3px 0;")
        ...
        row3_layout.setContentsMargins(0, 5, 0, 0)
        ...
        model_group_layout.setSpacing(5)

        model_group_label = QLabel("模型操作")
        model_group_label.setFont(data_group_font)
        model_group_label.setStyleSheet("color: #2c3e50; margin: 6px 0 3px 0;")
        ...
        row5_layout.setContentsMargins(0, 5, 0, 0)
        ...
        row8_layout.setContentsMargins(0, 5, 0, 0)
        row8_layout.setSpacing(5)
        ...
        row10_layout.setContentsMargins(0, 5, 0, 0)
        row10_layout.setSpacing(5)
        ...
        spacer2 = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Expanding)
        main_layout.addItem(spacer2)

        main_layout.addWidget(predict_group_widget)

        spacer3 = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Expanding)
        main_layout.addItem(spacer3)

        main_layout.addWidget(view_group_widget)

        spacer4 = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Expanding)
        main_layout.addItem(spacer4)

        main_layout.addWidget(tools_group_widget)

        # 在系统工具组和状态指示器之间添加相等的弹性空间
        spacer5 = QSpacerItem(20, 10, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        status_row2_layout.setContentsMargins(0, 5, 0, 0)
        status_row2_layout.setSpacing(10)
